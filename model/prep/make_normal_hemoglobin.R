...
means <- get_draws(location_id = c(1), gbd_id = 10487, measure_id = 19, year_id = years, age_group_id=age_ids, gbd_id_type = "modelable_entity_id", source="epi", version_id=500480, gbd_round_id = 7, decomp_step='iterative')
stdev <- get_draws(location_id = c(1), gbd_id = 10488, measure_id = 19, year_id = years, age_group_id=age_ids, gbd_id_type = "modelable_entity_id", source="epi", version_id=500969, gbd_round_id = 7, decomp_step='iterative')
...
# Pop aggregate
pops <- get_population(age_group_id=age_ids, location_id=1, year_id=years, sex_id=c(1,2), gbd_round_id=7, decomp_step='iterative')
pops[,run_id := NULL]
...
# Make square
loc_ids <- get_location_metadata(22, gbd_round_id=7)[,c("location_id")][[1]]
