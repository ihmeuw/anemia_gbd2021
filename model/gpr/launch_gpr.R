...
launch_gpr <- function(group, best=FALSE, notes="", cluster_proj="PROJECT", draws=1000, release_id) {
  ...
  ref <- fread("FILEPATH/paths.csv")[me_group==group,] 
...
## Batch launch all models 
  ...
  crosswalk_version_id <- config_file[me_name==me & is_best==1, crosswalk_version_id]
  mark_best   <- best
